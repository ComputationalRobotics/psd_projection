...
void express_FP32_Lt(
    ...
    for (int i = 0; i < coeff.size(); i++) {
        ...
        // A2 = A * A
        LtSgemm(cublasLtH, CUBLAS_OP_N, CUBLAS_OP_N, n, n, n, &one, A, n, A, n, &zero, A2, n, workspace, workspace_size);

        // A3 = A2 * A
        LtSgemm(cublasLtH, CUBLAS_OP_N, CUBLAS_OP_N, n, n, n, &one, A2, n, A, n, &zero, A3, n, workspace, workspace_size);

        // A5 = A3 * A2
        LtSgemm(cublasLtH, CUBLAS_OP_N, CUBLAS_OP_N, n, n, n, &one, A3, n, A2, n, &zero, A5, n, workspace, workspace_size);;
    ...
    // Wout = W * A
    LtSgemm(cublasLtH, CUBLAS_OP_N, CUBLAS_OP_N, n, n, n, &one, W, n, A, n, &zero, Wout, n, workspace, workspace_size);
