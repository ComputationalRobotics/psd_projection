...
TEST(CompositeFP32Lt, Deterministic)
{
    ...
    composite_FP32_Lt(cublasH, cublasLtH, dA, n, 0);
...
TEST(CompositeFP32Lt, UniformScaled)
{
    cusolverDnHandle_t solverH; cublasHandle_t cublasH;
    CHECK_CUSOLVER(cusolverDnCreate(&solverH));
    CHECK_CUBLAS(cublasCreate(&cublasH));
...
TEST(CompositeFP32Lt, UniformNonScaled1024)
{
    cusolverDnHandle_t solverH; cublasHandle_t cublasH;
    CHECK_CUSOLVER(cusolverDnCreate(&solverH));
    CHECK_CUBLAS(cublasCreate(&cublasH));
